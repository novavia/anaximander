...
# Patch of attributes to add the *inherit* keyword argument
# If inherit is False, then attributes declared in parent classes are
# ignored. The intended use is for the programmer to explicitly declare
# all attributes of a class, irrespective of its inheritance chain.
